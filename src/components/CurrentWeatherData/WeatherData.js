...
const WeatherData = ({ currentUser }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0">
      ...
      >
        <div className="h-full relative flex items-center justify-between p-2">
          ...
          <button
            ...
            className="bg-blue-700  hover:bg-purple-600 focus:bg-purple-600 w-20 h-12 rounded-full flex justify-center items-center transition"
          >
      ...
      {/* card */}
      <div className="w-full max-w-[700px] bg-black/20 min-h-[584px] text-black backdrop-blur-[80px] rounded-[32px] py-12 px-3">
        {loading ? (
